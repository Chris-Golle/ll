<div class="board-animation-page">
    ...
    <div class="scroll-content">
        <div class="completion-message">
            <?php
            $completion_message = get_post_meta(get_the_ID(), '_completion_message', true);
            if ($completion_message) {
                echo wp_kses_post($completion_message);
            } else {
                echo '<h1>🎉 You made it! 🎉</h1>';
            }
            ?>
        </div>
    </div>
